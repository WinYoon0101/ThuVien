 ...
 * @author Admin
 */
public class NopPhat extends javax.swing.JFrame {
        PhieuThuDAO pt = new PhieuThuDAO();
        DefaultTableModel dtm;
    /**
     * Creates new form HomePage
     */
    public NopPhat() throws Exception {
        initComponents();
        ...
        String tieude[] = new String[]{ "Mã Phiếu Thu", "Mã Phiếu Mượn"," Tổng Tiền", "Còn Lại"};
    ...
    public void updateDB () {
        ...
        dtm.setRowCount(0);
        ArrayList<PhieuThuDTO> arr = new ArrayList<>();
        try {

            arr = pt.getDSPT(pMaND);
            for (PhieuThuDTO dto : arr) {
    
    String mapt = dto.getMAPT();
    int mapm = dto.getMAPM();
    int tongNo = dto.getTongNo();
    int conLai = dto.getConLai();
    
    
    
    Object[] row = {mapt,mapm,tongNo,conLai};
    dtm.addRow(row);
}
            
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(Form_6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
   ...
   public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NopPhat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
